...
import jsesh.android.graphics.BitmapStreamGraphics;
...
//    }
    ...
    public void export(ExportData data) {
        try {
            ...
            e.printStackTrace();    //FIXME ANDROID
...
//            OutputStream out = new FileOutputStream(f);
            String name = basename + num + "." + OUTPUT_FORMATS[outputFormatIndex];
            BitmapStreamGraphics g = new BitmapStreamGraphics(context, name,
                    scaledDimensions, OUTPUT_FORMATS[outputFormatIndex],
                    getEffectiveTransparency());
            if (!getEffectiveTransparency()) {
                g.fillWith(backgroundColor);
