...
public class SunHints {
    ...
    public static class Value {
        ...
        private synchronized static void register(Key key,
                                                  Value value) {
    ...
    public static final Key KEY_RENDERING =
        new Key(SunHints.INTKEY_RENDERING,
    ...
    public static final Key KEY_ANTIALIASING =
        new Key(SunHints.INTKEY_ANTIALIASING,
    ...
    public static final Key KEY_TEXT_ANTIALIASING =
        new Key(SunHints.INTKEY_TEXT_ANTIALIASING,
    ...
    public static final Key KEY_FRACTIONALMETRICS =
        new Key(SunHints.INTKEY_FRACTIONALMETRICS,
    ...
    public static final Key KEY_DITHERING =
        new Key(SunHints.INTKEY_DITHERING,
    ...
    public static final Key KEY_INTERPOLATION =
        new Key(SunHints.INTKEY_INTERPOLATION,
    ...
    public static final Key KEY_ALPHA_INTERPOLATION =
        new Key(SunHints.INTKEY_ALPHA_INTERPOLATION,
    ...
    public static final Key KEY_COLOR_RENDERING =
        new Key(SunHints.INTKEY_COLOR_RENDERING,
    ...
    public static final Key KEY_STROKE_CONTROL =
        new Key(SunHints.INTKEY_STROKE_CONTROL,
